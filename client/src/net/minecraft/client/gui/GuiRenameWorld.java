...
public class GuiRenameWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, Lang.format("selectWorld.renameButton", new Object[0])));
		this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 120 + 12, Lang.format("gui.cancel", new Object[0])));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, Lang.format("selectWorld.renameTitle", new Object[0]), this.width / 2, 20, 16777215);
		this.drawString(this.fontRendererObj, Lang.format("selectWorld.enterName", new Object[0]), this.width / 2 - 100, 47, 10526880);
