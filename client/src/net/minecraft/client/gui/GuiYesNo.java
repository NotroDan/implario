...
public class GuiYesNo extends GuiScreen {
	...
	private final List<String> field_175298_s = new java.util.ArrayList<>();
	 ...
	 */
	public void initGui() {
		this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height / 6 + 96, this.confirmButtonText));
		this.buttonList.add(new GuiButton(1, this.width / 2 - 155 + 160, this.height / 6 + 96, this.cancelButtonText));
