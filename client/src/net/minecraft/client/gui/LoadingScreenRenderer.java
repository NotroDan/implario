...
public class LoadingScreenRenderer implements IProgressUpdate {
	...
	public void setLoadingProgress(int progress) {
		...
		if (i - this.systemTime >= 100L) {
			...
			this.mc.fontRenderer.drawStringWithShadow(this.currentlyDisplayedText, (float) ((k - this.mc.fontRenderer.getStringWidth(this.currentlyDisplayedText)) / 2), (float) (l / 2 - 4 - 16),
					16777215);
	...
	private boolean isStateInvalid() {
		if (!this.mc.running) if (!this.field_73724_e) throw new MinecraftError();
