...
public class WorldClient extends World {
	...
	public void removeAllEntities() {
		...
		for (Entity anUnloadedEntityList : this.unloadedEntityList) {
			this.onEntityRemoved(anUnloadedEntityList);
		}
	...
	public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
		...
		crashreportcategory.addCrashSectionCallable("Forced entities", () -> this.entityList.size() + " total; " + this.entityList.toString());
		crashreportcategory.addCrashSectionCallable("Retry entities", () -> this.entitySpawnQueue.size() + " total; " + this.entitySpawnQueue.toString());
		crashreportcategory.addCrashSectionCallable("Server brand", () -> this.mc.thePlayer.getClientBrand());
		crashreportcategory.addCrashSectionCallable("Server type",
				() -> this.mc.getIntegratedServer() == null ? "Non-integrated multiplayer server" : "Integrated singleplayer server");
