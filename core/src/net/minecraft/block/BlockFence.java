...
public class BlockFence extends Block
{
    ...
    {
        return worldIn.isClientSide ? true : ItemLead.attachToFence(playerIn, worldIn, pos);
    }
    ...
    {
        return state.withProperty(NORTH, this.canConnectTo(worldIn, pos.north())).withProperty(EAST, this.canConnectTo(worldIn, pos.east())).withProperty(SOUTH,
