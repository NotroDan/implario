...
public abstract class BlockSlab extends Block {
	...
	public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
		...
		return flag1 ? side == EnumFacing.DOWN ? true : side == EnumFacing.UP && super.shouldSideBeRendered(worldIn, pos, side) ? true : !isSlab(
				iblockstate.getBlock()) || !flag : side == EnumFacing.UP ? true : side == EnumFacing.DOWN && super.shouldSideBeRendered(worldIn, pos, side) ? true : !isSlab(
				iblockstate.getBlock()) || flag;
	}
