...
public class BlockSnow extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
		...
		float f = 0.125F;
		return new AxisAlignedBB((double) pos.getX() + this.minX, (double) pos.getY() + this.minY, (double) pos.getZ() + this.minZ, (double) pos.getX() + this.maxX,
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		...
		return block != Blocks.ice && block != Blocks.packed_ice ? block.getMaterial() == Material.leaves ? true : block == this && ((Integer) iblockstate.getValue(
				LAYERS)).intValue() >= 7 ? true : block.isOpaqueCube() && block.blockMaterial.blocksMovement() : false;
	}
