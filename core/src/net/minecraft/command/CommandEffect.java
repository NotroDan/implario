		...
		else
		{
			...
			if (i >= 0 && i < Potion.potionTypes.length && Potion.potionTypes[i] != null)
			{
				...
				if (l > 0)
				{
					...
					notifyOperators(sender, this, "commands.effect.success", new Object[] {new ChatComponentTranslation(potioneffect.getEffectName(), new Object[0]), i, k, entitylivingbase.getName(),
							l
					});
				}
