...
public class CommandDifficulty extends CommandBase {
	...
	protected EnumDifficulty getDifficultyFromCommand(String p_180531_1_) throws CommandException, NumberInvalidException {
		return !p_180531_1_.equalsIgnoreCase("peaceful") && !p_180531_1_.equalsIgnoreCase("p") ? !p_180531_1_.equalsIgnoreCase("easy") && !p_180531_1_.equalsIgnoreCase(
				"e") ? !p_180531_1_.equalsIgnoreCase("normal") && !p_180531_1_.equalsIgnoreCase("n") ? !p_180531_1_.equalsIgnoreCase("hard") && !p_180531_1_.equalsIgnoreCase(
				"h") ? EnumDifficulty.getDifficultyEnum(parseInt(p_180531_1_, 0, 3)) : EnumDifficulty.HARD : EnumDifficulty.NORMAL : EnumDifficulty.EASY : EnumDifficulty.PEACEFUL;
	}
