...
public class CommandScoreboard extends CommandBase {
	...
	protected void setTeamOption(ICommandSender sender, String[] args, int index) throws CommandException {
		...
		if (scoreplayerteam != null) {
			...
			if (!s.equalsIgnoreCase("color") && !s.equalsIgnoreCase("friendlyfire") && !s.equalsIgnoreCase("seeFriendlyInvisibles") && !s.equalsIgnoreCase("nametagVisibility") && !s.equalsIgnoreCase(
	...
	protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
		...
		if (p_147186_2_.length > p_147186_3_) {
			...
			for (ScorePlayerTeam scoreplayerteam1 : collection1) {
				p_147186_1_.sendMessage(new ChatComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] {
						scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(),
	...
	protected void listObjectives(ICommandSender p_147196_1_) throws CommandException {
		...
		for (ScoreObjective scoreobjective : collection) {
			p_147196_1_.sendMessage(new ChatComponentTranslation("commands.scoreboard.objectives.list.entry",
					new Object[] {scoreobjective.getName(), scoreobjective.getDisplayName(), scoreobjective.getCriteria().getName()}));
		}
	}
	...
	protected void listPlayers(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException {
		...
		if (p_147195_2_.length > p_147195_3_) {
			...
			for (Score score : map.values()) {
				p_147195_1_.sendMessage(new ChatComponentTranslation("commands.scoreboard.players.list.player.entry",
						new Object[] {score.getScorePoints(), score.getObjective().getDisplayName(), score.getObjective().getName()}));
			}
		} else {
	...
	public boolean isUsernameIndex(String[] args, int index) {
		return !args[0].equalsIgnoreCase("players") ? args[0].equalsIgnoreCase("teams") ? index == 2 : false : args.length > 1 && args[1].equalsIgnoreCase(
