...
public class Enchantments {
	...
	public static Enchantment
			protection, fireProtection, featherFalling, blastProtection, projectileProtection, respiration, aquaAffinity, thorns, depthStrider,
			sharpness, smite, baneOfArthropods, knockback, fireAspect, looting,
			efficiency, silkTouch, unbreaking, fortune, power, punch,
			flame, infinity, luckOfTheSea, lure;
