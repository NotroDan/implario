...
public class DataWatcher {
	...
	public <T> void addObject(int id, T object) {
		...
		if (integer == null) throw new IllegalArgumentException("Unknown data type: " + object.getClass());
		if (id > 31) throw new IllegalArgumentException("Data value id is too big with " + id + "! (Max is 31)");
