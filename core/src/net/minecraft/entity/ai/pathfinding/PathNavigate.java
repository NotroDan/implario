package net.minecraft.entity.ai.pathfinding;
...
public abstract class PathNavigate
{
    ...
    public PathNavigate(VanillaEntity entitylivingIn, World worldIn)
    {
     ...
     * net.minecraft.entity.ai.pathfinding.PathEntity}
     */
