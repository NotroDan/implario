package net.minecraft.entity.ai.tasks.wolf;
...
public class EntityAIBeg extends EntityAIBase {
	...
	public void updateTask() {
		this.theWolf.getLookHelper().setLookPosition(this.thePlayer.posX, this.thePlayer.posY + (double) this.thePlayer.getEyeHeight(), this.thePlayer.posZ, 10.0F,
