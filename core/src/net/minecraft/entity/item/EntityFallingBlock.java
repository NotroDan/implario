				...
				if (this.onGround) {
					...
					if (this.worldObj.getBlockState(blockpos1).getBlock() != Blocks.piston_extension) {
						...
						if (!this.canSetAsBlock) {
							if (this.worldObj.canBlockBePlaced(block, blockpos1, true, EnumFacing.UP, (Entity) null, (ItemStack) null) && !BlockFalling.canFallInto(this.worldObj,
									blockpos1.down()) && this.worldObj.setBlockState(blockpos1, this.fallTile, 3)) {
