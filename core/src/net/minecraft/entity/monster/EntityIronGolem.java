...
import net.minecraft.entity.ai.tasks.village.EntityAIDefendVillage;
import net.minecraft.entity.ai.tasks.EntityAIHurtByTarget;
import net.minecraft.entity.ai.tasks.village.EntityAILookAtVillager;
import net.minecraft.entity.ai.tasks.EntityAILookIdle;
import net.minecraft.entity.ai.tasks.village.EntityAIMoveThroughVillage;
import net.minecraft.entity.ai.tasks.EntityAIMoveTowardsRestriction;
import net.minecraft.entity.ai.tasks.village.EntityAIMoveTowardsTarget;
...
import net.minecraft.world.gen.feature.village.Village;
...
public class EntityIronGolem extends EntityGolem
{
    ...
    public EntityIronGolem(World worldIn)
    {
        ...
        this.targetTasks.addTask(3, new EntityIronGolem.AINearestAttackableTargetNonCreeper(this, VanillaEntity.class, 10, false, true, IMob.VISIBLE_MOB_SELECTOR));
    }
