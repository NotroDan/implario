...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob
{
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_)
    {
        ...
        int i = EnchantmentHelper.getEnchantmentLevel(Enchantments.power.effectId, this.getHeldItem());
        int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.punch.effectId, this.getHeldItem());
        ...
        if (EnchantmentHelper.getEnchantmentLevel(Enchantments.flame.effectId, this.getHeldItem()) > 0 || this.getSkeletonType() == 1)
        {
