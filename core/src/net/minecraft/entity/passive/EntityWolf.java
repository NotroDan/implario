...
import net.minecraft.entity.ai.tasks.EntityAIAttackOnCollide;
import net.minecraft.entity.ai.tasks.wolf.EntityAIBeg;
import net.minecraft.entity.ai.tasks.EntityAIFollowOwner;
import net.minecraft.entity.ai.tasks.EntityAIHurtByTarget;
import net.minecraft.entity.ai.tasks.EntityAILeapAtTarget;
import net.minecraft.entity.ai.tasks.EntityAILookIdle;
import net.minecraft.entity.ai.tasks.EntityAIMate;
import net.minecraft.entity.ai.tasks.EntityAINearestAttackableTarget;
import net.minecraft.entity.ai.tasks.wolf.EntityAIOwnerHurtByTarget;
import net.minecraft.entity.ai.tasks.wolf.EntityAIOwnerHurtTarget;
import net.minecraft.entity.ai.tasks.EntityAISwimming;
import net.minecraft.entity.ai.tasks.EntityAITargetNonTamed;
import net.minecraft.entity.ai.tasks.EntityAIWander;
import net.minecraft.entity.ai.tasks.EntityAIWatchClosest;
...
public class EntityWolf extends EntityTameable
{
    ...
    public EntityWolf(World worldIn)
    {
        ...
        this.targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntityAnimal.class, false,
				(Predicate<Entity>) e -> e instanceof EntitySheep || e instanceof EntityRabbit));
    ...
    public void onUpdate()
    {
        ...
        if (this.isBegging())
        {
            this.headRotationCourse += (1.0F - this.headRotationCourse) * 0.4;
        }
        else
        {
            this.headRotationCourse += (0.0F - this.headRotationCourse) * 0.4;
        }
