...
public abstract class EntityPlayer extends EntityLivingBase {
	...
	public void onLivingUpdate() {
		...
		float f1 = (float) (Math.atan(-this.motionY * 0.2) * 15.0D);
	...
	public float getProtectionCoef() {
		DamageSource src = DamageSource.causePlayerDamage(this);

		float damageAmount = this.applyArmorCalculations(src, 9);
		return this.applyPotionDamageCalculations(src, damageAmount) / 9F;
	...
	public boolean interactWith(Entity e) {
		...
		if (!e.interactFirst(this)) {
			if (itemstack != null && e instanceof EntityLivingBase) {
