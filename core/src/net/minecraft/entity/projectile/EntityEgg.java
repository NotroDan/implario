...
public class EntityEgg extends EntityThrowable {
	...
	protected void onImpact(MovingObjectPosition mop) {
		...
		for (int k = 0; k < 8; ++k) {
			this.worldObj.spawnParticle(ParticleType.ITEM_CRACK, this.posX, this.posY, this.posZ, ((double) this.rand.nextFloat() - 0.5D) * 0.08D, ((double) this.rand.nextFloat() - 0.5D) * 0.08D,
