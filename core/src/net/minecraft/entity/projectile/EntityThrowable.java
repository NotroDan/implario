...
public abstract class EntityThrowable extends Entity implements IProjectile {
	...
	public void onUpdate() {
		...
		if (movingobjectposition != null) {
			if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.worldObj.getBlockState(movingobjectposition.getBlockPos()).getBlock() == Blocks.portal) {
				...
				if (Events.eventProjectileHit.isUseful())
					Events.eventProjectileHit.call(new ProjectileHitEvent(this, movingobjectposition));
		...
		if (this.isInWater()) {
			for (int i = 0; i < 4; ++i) {
				float f4 = 0.25F;
				this.worldObj.spawnParticle(ParticleType.WATER_BUBBLE, this.posX - this.motionX * (double) f4, this.posY - this.motionY * (double) f4, this.posZ - this.motionZ * (double) f4,
	...
	public void writeEntityToNBT(NBTTagCompound tagCompound) {
		...
		if ((this.throwerName == null || this.throwerName.length() == 0) && this.thrower instanceof Player) {
