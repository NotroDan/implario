...
public class InventoryHelper {
	...
	public static void dropInventoryItems(World worldIn, BlockPos pos, Inventory p_180175_2_) {
		func_180174_a(worldIn, (double) pos.getX(), (double) pos.getY(), (double) pos.getZ(), p_180175_2_);
	}

	public static void func_180176_a(World worldIn, Entity p_180176_1_, Inventory p_180176_2_) {
		func_180174_a(worldIn, p_180176_1_.posX, p_180176_1_.posY, p_180176_1_.posZ, p_180176_2_);
	}

	private static void func_180174_a(World worldIn, double x, double y, double z, Inventory p_180174_7_) {
