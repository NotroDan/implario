...
public class Slot {
	...
	/**
	 * Если A содержит больше предметов, чем B, то вызывается onCrafting(A, countIncrease)
	 */
	public void onSlotChange(ItemStack a, ItemStack b) {
		if (a == null || b == null) return;
		if (a.getItem() != b.getItem()) return;
		int i = b.stackSize - a.stackSize;
		if (i > 0) this.onCrafting(a, i);
	}
