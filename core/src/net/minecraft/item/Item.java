...
public class Item {
	...
	public static void registerItems() {
		registerItemBlock(Blocks.stone, new ItemMultiTexture(Blocks.stone, Blocks.stone,
				b -> BlockStone.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("stone"));
		...
		registerItemBlock(Blocks.dirt, new ItemMultiTexture(Blocks.dirt, Blocks.dirt,
				b -> BlockDirt.DirtType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("dirt"));
		registerItemBlock(Blocks.cobblestone);
		registerItemBlock(Blocks.planks, new ItemMultiTexture(Blocks.planks, Blocks.planks,
				b -> BlockPlanks.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("wood"));
		registerItemBlock(Blocks.sapling, new ItemMultiTexture(Blocks.sapling, Blocks.sapling,
				b -> BlockPlanks.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("sapling"));
		registerItemBlock(Blocks.bedrock);
		registerItemBlock(Blocks.sand, new ItemMultiTexture(Blocks.sand, Blocks.sand,
				b -> BlockSand.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("sand"));
		...
		registerItemBlock(Blocks.log, new ItemMultiTexture(Blocks.log, Blocks.log,
				b -> BlockPlanks.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("log"));
		registerItemBlock(Blocks.log2, new ItemMultiTexture(Blocks.log2, Blocks.log2,
				b -> BlockPlanks.EnumType.byMetadata(b.getMetadata() + 4).getUnlocalizedName()).setUnlocalizedName("log"));
		...
		registerItemBlock(Blocks.sponge, new ItemMultiTexture(Blocks.sponge, Blocks.sponge, b -> (b.getMetadata() & 1) == 1 ? "wet" : "dry").setUnlocalizedName("sponge"));
		...
		registerItemBlock(Blocks.sandstone, new ItemMultiTexture(Blocks.sandstone, Blocks.sandstone,
				b -> BlockSandStone.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("sandStone"));
		...
		registerItemBlock(Blocks.yellow_flower, new ItemMultiTexture(Blocks.yellow_flower, Blocks.yellow_flower,
				b -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.YELLOW, b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("flower"));
		registerItemBlock(Blocks.red_flower, new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower,
				b -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.RED, b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("rose"));
		...
		registerItemBlock(Blocks.monster_egg, new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg,
				b -> BlockSilverfish.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("monsterStoneEgg"));
		registerItemBlock(Blocks.stonebrick, new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick,
				b -> BlockStoneBrick.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("stonebricksmooth"));
		...
		registerItemBlock(Blocks.cobblestone_wall, new ItemMultiTexture(Blocks.cobblestone_wall, Blocks.cobblestone_wall,
				b -> BlockWall.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("cobbleWall"));
		...
		registerItemBlock(Blocks.double_plant, new ItemDoublePlant(Blocks.double_plant, Blocks.double_plant,
				b -> BlockDoublePlant.EnumPlantType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("doublePlant"));
		...
		registerItemBlock(Blocks.prismarine, new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine,
				b -> BlockPrismarine.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("prismarine"));
		...
		registerItemBlock(Blocks.red_sandstone, new ItemMultiTexture(Blocks.red_sandstone, Blocks.red_sandstone,
				b -> BlockRedSandstone.EnumType.byMetadata(b.getMetadata()).getUnlocalizedName()).setUnlocalizedName("redSandStone"));
