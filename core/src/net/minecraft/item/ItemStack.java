...
public final class ItemStack {
	...
	public void damageItem(int amount, EntityLivingBase entityIn) {
		if (!(entityIn instanceof EntityPlayer) || !((EntityPlayer) entityIn).capabilities.isCreativeMode) if (this.isItemStackDamageable()) if (this.attemptDamageItem(amount, entityIn.getRNG())) {
