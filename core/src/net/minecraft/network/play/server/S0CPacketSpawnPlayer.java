...
public class S0CPacketSpawnPlayer implements Packet<INetHandlerPlayClient> {
	...
	private List<DataWatcher.WatchableObject> watchedList;
	...
	public void readPacketData(PacketBuffer buf) throws IOException {
		...
		this.watchedList = DataWatcher.readWatchedListFromPacketBuffer(buf);
	}
	...
	public List<DataWatcher.WatchableObject> getWatchedList() {
		if (this.watchedList == null) {
			this.watchedList = this.watcher.getAllWatched();
		}
