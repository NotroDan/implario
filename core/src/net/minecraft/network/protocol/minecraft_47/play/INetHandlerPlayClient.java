...
import net.minecraft.network.protocol.minecraft_47.play.server.S00PacketKeepAlive;
import net.minecraft.network.protocol.minecraft_47.play.server.S01PacketJoinGame;
...
import net.minecraft.network.protocol.minecraft_47.play.server.S04PacketEntityEquipment;
import net.minecraft.network.protocol.minecraft_47.play.server.S05PacketSpawnPosition;
import net.minecraft.network.protocol.minecraft_47.play.server.S06PacketUpdateHealth;
import net.minecraft.network.protocol.minecraft_47.play.server.S07PacketRespawn;
import net.minecraft.network.protocol.minecraft_47.play.server.S08PacketPlayerPosLook;
import net.minecraft.network.protocol.minecraft_47.play.server.S09PacketHeldItemChange;
import net.minecraft.network.protocol.minecraft_47.play.server.S0APacketUseBed;
import net.minecraft.network.protocol.minecraft_47.play.server.S0BPacketAnimation;
import net.minecraft.network.protocol.minecraft_47.play.server.S0CPacketSpawnPlayer;
import net.minecraft.network.protocol.minecraft_47.play.server.S0DPacketCollectItem;
import net.minecraft.network.protocol.minecraft_47.play.server.S0EPacketSpawnObject;
import net.minecraft.network.protocol.minecraft_47.play.server.S0FPacketSpawnMob;
import net.minecraft.network.protocol.minecraft_47.play.server.S10PacketSpawnPainting;
import net.minecraft.network.protocol.minecraft_47.play.server.S11PacketSpawnExperienceOrb;
import net.minecraft.network.protocol.minecraft_47.play.server.S12PacketEntityVelocity;
import net.minecraft.network.protocol.minecraft_47.play.server.S13PacketDestroyEntities;
import net.minecraft.network.protocol.minecraft_47.play.server.S14PacketEntity;
import net.minecraft.network.protocol.minecraft_47.play.server.S18PacketEntityTeleport;
import net.minecraft.network.protocol.minecraft_47.play.server.S19PacketEntityHeadLook;
...
import net.minecraft.network.protocol.minecraft_47.play.server.S1CPacketEntityMetadata;
import net.minecraft.network.protocol.minecraft_47.play.server.S1DPacketEntityEffect;
import net.minecraft.network.protocol.minecraft_47.play.server.S1EPacketRemoveEntityEffect;
import net.minecraft.network.protocol.minecraft_47.play.server.S1FPacketSetExperience;
import net.minecraft.network.protocol.minecraft_47.play.server.S20PacketEntityProperties;
import net.minecraft.network.protocol.minecraft_47.play.server.S21PacketChunkData;
import net.minecraft.network.protocol.minecraft_47.play.server.S22PacketMultiBlockChange;
import net.minecraft.network.protocol.minecraft_47.play.server.S23PacketBlockChange;
import net.minecraft.network.protocol.minecraft_47.play.server.S24PacketBlockAction;
import net.minecraft.network.protocol.minecraft_47.play.server.S25PacketBlockBreakAnim;
import net.minecraft.network.protocol.minecraft_47.play.server.S26PacketMapChunkBulk;
import net.minecraft.network.protocol.minecraft_47.play.server.S27PacketExplosion;
...
import net.minecraft.network.protocol.minecraft_47.play.server.S2APacketParticles;
...
import net.minecraft.network.protocol.minecraft_47.play.server.S2EPacketCloseWindow;
import net.minecraft.network.protocol.minecraft_47.play.server.S2FPacketSetSlot;
import net.minecraft.network.protocol.minecraft_47.play.server.S30PacketWindowItems;
import net.minecraft.network.protocol.minecraft_47.play.server.S31PacketWindowProperty;
import net.minecraft.network.protocol.minecraft_47.play.server.S32PacketConfirmTransaction;
import net.minecraft.network.protocol.minecraft_47.play.server.S33PacketUpdateSign;
import net.minecraft.network.protocol.minecraft_47.play.server.S34PacketMaps;
import net.minecraft.network.protocol.minecraft_47.play.server.S35PacketUpdateTileEntity;
import net.minecraft.network.protocol.minecraft_47.play.server.S36PacketSignEditorOpen;
...
import net.minecraft.network.protocol.minecraft_47.play.server.S39PacketPlayerAbilities;
import net.minecraft.network.protocol.minecraft_47.play.server.S3APacketTabComplete;
...
import net.minecraft.network.protocol.minecraft_47.play.server.S41PacketServerDifficulty;
import net.minecraft.network.protocol.minecraft_47.play.server.S42PacketCombatEvent;
import net.minecraft.network.protocol.minecraft_47.play.server.S43PacketCamera;
import net.minecraft.network.protocol.minecraft_47.play.server.S44PacketWorldBorder;
import net.minecraft.network.protocol.minecraft_47.play.server.S45PacketTitle;
import net.minecraft.network.protocol.minecraft_47.play.server.S46PacketSetCompressionLevel;
import net.minecraft.network.protocol.minecraft_47.play.server.S47PacketPlayerListHeaderFooter;
import net.minecraft.network.protocol.minecraft_47.play.server.S48PacketResourcePackSend;
import net.minecraft.network.protocol.minecraft_47.play.server.S49PacketUpdateEntityNBT;
