...
public class S01PacketJoinGame implements Packet<INetHandlerPlayClient> {
	...
	public S01PacketJoinGame(int entityIdIn, WorldSettings.GameType gameTypeIn, boolean hardcoreModeIn, int dimensionIn, EnumDifficulty difficultyIn, int maxPlayersIn, WorldType worldTypeIn,
	...
	public void readPacketData(PacketBuffer buf) throws IOException {
		...
		i = i & 0b11111111111111111111111111110111;
		...
		if (this.worldType == null) this.worldType = WorldType.VOID;
