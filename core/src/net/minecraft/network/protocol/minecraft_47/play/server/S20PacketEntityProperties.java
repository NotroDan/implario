...
public class S20PacketEntityProperties implements Packet<INetHandlerPlayClient> {
	...
	private final List<S20PacketEntityProperties.Snapshot> field_149444_b = new ArrayList<>();
	...
	public S20PacketEntityProperties(int entityIdIn, Collection<IAttributeInstance> p_i45236_2_) {
		...
		for (IAttributeInstance iattributeinstance : p_i45236_2_) {
			this.field_149444_b.add(
					new S20PacketEntityProperties.Snapshot(iattributeinstance.getAttribute().getAttributeUnlocalizedName(), iattributeinstance.getBaseValue(), iattributeinstance.func_111122_c()));
		}
	}
