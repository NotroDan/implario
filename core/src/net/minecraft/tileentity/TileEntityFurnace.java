...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	private boolean canSmelt() {
		...
		return itemstack != null && (this.furnaceItemStacks[2] == null || this.furnaceItemStacks[2].isItemEqual(itemstack) &&
	...
	public void smeltItem() {
		...
		if (this.furnaceItemStacks[0].getItem() == Item.getItemFromBlock(
				Blocks.sponge) && this.furnaceItemStacks[0].getMetadata() == 1 && this.furnaceItemStacks[1] != null && this.furnaceItemStacks[1].getItem() == Items.bucket) {
