...
public class Session {
	...
	public GameProfile getProfile() {
		try {
			...
			System.out.println("Вход в игру выполнен с некорректным UUID: " + getPlayerID());
			System.out.println("Лицензионные сервера будут посылать вас в жопу, не удивляйтесь.");
