...
public final class WorldSettings {
	...
	/**
	 * Стартовый набор (Бонусный сундук для миров ваниллы, платформа из блоков для пустого мира)
	 */
	private boolean staterKitEnabled;
	 ...
	 */
	public boolean isStaterKitEnabled() {
		return this.staterKitEnabled;
	}
