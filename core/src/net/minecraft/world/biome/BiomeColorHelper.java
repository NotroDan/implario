...
public class BiomeColorHelper {
	...
	private static final BiomeColorHelper.ColorResolver field_180291_a = Biome::getGrassColorAtPos;
	private static final BiomeColorHelper.ColorResolver field_180289_b = Biome::getFoliageColorAtPos;
	private static final BiomeColorHelper.ColorResolver field_180290_c = (biome, blockPosition) -> biome.getWaterColorMultiplier();

	private static int func_180285_a(IBlockAccess world, BlockPos p_180285_1_, BiomeColorHelper.ColorResolver resolver) {
		int i = 0;
		int j = 0;
		int k = 0;
		...
		for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(p_180285_1_.add(-1, 0, -1), p_180285_1_.add(1, 0, 1))) {
			int l = resolver.getColorAtPos(world.getBiomeGenForCoords(blockpos$mutableblockpos), blockpos$mutableblockpos);
			i += (l & 16711680) >> 16;
			j += (l & 65280) >> 8;
			k += l & 255;
		}
	...
	interface ColorResolver {
		...
		int getColorAtPos(Biome p_180283_1_, BlockPos blockPosition);
