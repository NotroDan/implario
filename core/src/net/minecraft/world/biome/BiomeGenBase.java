...
public abstract class BiomeGenBase extends Biome {
	...
	public BiomeGenBase.TempCategory getTempCategory() {
		return (double) this.temperature < 0.2D ? BiomeGenBase.TempCategory.COLD : (double) this.temperature < 1.0D ? TempCategory.MEDIUM : TempCategory.WARM;
	}
	...
	static {
		...
		for (Biome biome : biomeList) {
			...
			if (biome.legacyId < 128) explorationBiomesList.add(biome);
		}
