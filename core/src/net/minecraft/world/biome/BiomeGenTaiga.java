...
public class BiomeGenTaiga extends BiomeGenBase {
	...
	public BiomeGenTaiga(int id, String name, int v) {
		super(id, name);
		this.field_150644_aH = v;
	...
	public WorldGenAbstractTree genBigTreeChance(Random rand) {
		return (this.field_150644_aH == 1 || this.field_150644_aH == 2) && rand.nextInt(3) == 0 ? this.field_150644_aH != 2 && rand.nextInt(
				13) != 0 ? field_150641_aE : field_150642_aF : rand.nextInt(3) == 0 ? field_150639_aC : field_150640_aD;
	}
	...
	protected BiomeGenBase createMutatedBiome(int id) {
		return this.legacyId == BiomeGenBase.megaTaiga.legacyId ?
				this .createMutatedBiome(id, "Mega Spruce Taiga") :
				super.createMutatedBiome(id);
	}

	protected BiomeGenBase createMutatedBiome(int id, String name) {
		return new BiomeGenTaiga(id, name, 2).func_150557_a(5858897, true)
				.setFillerBlockMetadata(5159473).setTemperatureRainfall(0.25F, 0.8F)
				.setHeight(new BiomeGenBase.Height(this.minHeight, this.maxHeight));
	}
