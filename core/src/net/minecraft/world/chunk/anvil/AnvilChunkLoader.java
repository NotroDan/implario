		...
		if (p_75823_2_.hasKey("TileTicks", 9)) {
			...
			if (nbttaglist3 != null) {
				for (int i3 = 0; i3 < nbttaglist3.tagCount(); ++i3) {
					...
					worldIn.scheduleBlockUpdate(new BlockPos(nbttagcompound3.getInteger("x"), nbttagcompound3.getInteger("y"), nbttagcompound3.getInteger("z")), block, nbttagcompound3.getInteger("t"),
