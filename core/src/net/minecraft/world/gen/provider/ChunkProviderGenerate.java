package net.minecraft.world.gen.provider;
...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void replaceBlocksForBiome(int p_180517_1_, int p_180517_2_, ChunkPrimer p_180517_3_, Biome[] p_180517_4_) {
		...
		for (int i = 0; i < 16; ++i) {
			for (int j = 0; j < 16; ++j) {
				BiomeGenBase biomegenbase = p_180517_4_[j + i * 16].toGenBase();
	...
	private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_) {
		...
		for (int k = 0; k < 5; ++k) {
			for (int l = 0; l < 5; ++l) {
				...
				float f4 = 0.0F;
				int i1 = 2;
				BiomeGenBase biomegenbase = this.biomesForGeneration[k + 2 + (l + 2) * 10].toGenBase();

				for (int j1 = -i1; j1 <= i1; ++j1) {
					for (int k1 = -i1; k1 <= i1; ++k1) {
						BiomeGenBase biomegenbase1 = this.biomesForGeneration[k + j1 + 2 + (l + k1 + 2) * 10].toGenBase();
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
		...
		BiomeGenBase biomegenbase = this.worldObj.getBiomeGenForCoords(blockpos.add(16, 0, 16)).toGenBase();
	...
	public List<SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
		BiomeGenBase biomegenbase = this.worldObj.getBiomeGenForCoords(pos).toGenBase();
