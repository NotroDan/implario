...
//				this.terrainType = WorldType.DEFAULT_OLD;
	...
	public void addToCrashReport(CrashReportCategory category) {
		...
		category.addCrashSectionCallable("Level generator",
				() -> String.format("ID %02d - %s, ver %d. Features enabled: %b", WorldInfo.this.terrainType.getWorldTypeID(), WorldInfo.this.terrainType.getWorldTypeName(),
						WorldInfo.this.terrainType.getGeneratorVersion(),
		...
		category.addCrashSectionCallable("Level spawn location",
				() -> CrashReportCategory.getCoordinateInfo((double) WorldInfo.this.spawnX, (double) WorldInfo.this.spawnY, (double) WorldInfo.this.spawnZ));
		...
		category.addCrashSectionCallable("Level weather", () -> String.format("Rain time: %d (now: %b), thunder time: %d (now: %b)", WorldInfo.this.rainTime, WorldInfo.this.raining,
				WorldInfo.this.thunderTime,
				WorldInfo.this.thundering));
		category.addCrashSectionCallable("Level game mode",
				() -> String.format("Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", WorldInfo.this.theGameType.getName(), WorldInfo.this.theGameType.getID(),
