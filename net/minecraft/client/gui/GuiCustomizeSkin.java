	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.enabled) {
			if (button.id == 200) {
				...
				EnumPlayerModelParts part = ((GuiCustomizeSkin.ButtonPart) button).playerModelParts;
				Settings.toggleModelPart(part);
				button.displayString = this.func_175358_a(part);
			}
		}
	}
