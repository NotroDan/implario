...
public class GuiScreenOptionsSounds extends GuiScreen {
	 ...
	 */
	protected String title = "Настройки звуков";
	private String disabledCaption;

	public GuiScreenOptionsSounds(GuiScreen parent) {
		this.parent = parent;
	}
	...
	protected String getSoundVolume(SoundCategory category) {
		float f = Settings.getSoundLevel(category);
		return f == 0.0F ? this.disabledCaption : (int) (f * 100.0F) + "%";
	}
