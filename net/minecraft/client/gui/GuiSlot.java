...
//		tessellator.draw();
	...
	protected void overlayBackground(int startY, int endY, int startAlpha, int endAlpha) {
		...
		worldrenderer.pos((double) (this.left + this.width), (double) startY, 0.0D).tex((double) ((float) this.width / 32.0F), (double) ((float) startY / 32.0F)).color(64, 64, 64,
				startAlpha).endVertex();
