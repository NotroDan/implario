...
public class Blocks {
    ...
    public static final Block oak_door = getRegisteredBlock("oak_door");
    ...
    public static final Block oak_fence = getRegisteredBlock("oak_fence");
    ...
    public static final Block oak_fence_gate = getRegisteredBlock("oak_fence_gate");
    ...
    public static final Block slime_block = getRegisteredBlock("slime_block");
    ...
    private static Block getRegisteredBlock(String block_name) {
        return Block.blockRegistry.getObject(new ResourceLocation(block_name));
    }
