...
public class Bootstrap {
    ...
    static void registerDispenserBehaviors() {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.potionitem, new IBehaviorDispenseItem() {
            private final BehaviorDefaultDispenseItem magic = new BehaviorDefaultDispenseItem();
            ...
            public ItemStack dispense(IBlockSource source, final ItemStack stack) {
                ...
                }).dispense(source, stack): magic.dispense(source, stack);
            }
        });
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                if (Material.water.equals(material))
                    ...
                    if (!Material.air.equals(material) || !Material.water.equals(world.getBlockState(blockpos.down()).getBlock().getMaterial()))
                        return magic.dispense(source, stack);
                    else d3 = 0.0D;
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.flint_and_steel, new BehaviorDefaultDispenseItem() {
            ...
            protected void playDispenseSound(IBlockSource source) {
                source.getWorld().playAuxSFX(magic ? 1000 : 1001, source.getBlockPos(), 0);
            }
        });
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Item.getItemFromBlock(Blocks.tnt), new BehaviorDefaultDispenseItem() {
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(world, (double)blockpos.getX() + 0.5D,
                        (double)blockpos.getY(), (double)blockpos.getZ() + 0.5D, null);
    ...
    public static void printToSYSOUT(String print) {
        SYSOUT.println(print);
    }
}
