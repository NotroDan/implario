...
public class Achievement extends StatBase {
	...
	public String getDescription() {
		if (this.statStringFormatter == null) return StatCollector.translateToLocal(this.achievementDescription);
		try {
			return this.statStringFormatter.formatString(StatCollector.translateToLocal(this.achievementDescription));
		} catch (Exception ex) {return "Error: " + ex.getLocalizedMessage();}
	}
