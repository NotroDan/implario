    ...
    private static void initCraftableStats()
    {
        ...
        for (Item item : set)
        {
            if (item != null)
            {
                ...
                if (s != null)
                {
                    objectCraftStats[i] = new StatCrafting("stat.craftItem.", s, new ChatComponentTranslation("stat.craftItem", new Object[] {
							new ItemStack(item).getChatComponent()}), item).registerStat();
                }
            }
        }
    ...
    private static void initMiningStats()
    {
        for (Block block : Block.blockRegistry)
        {
            ...
            if (item != null)
            {
                ...
                {
                    mineBlockStatArray[i] = new StatCrafting("stat.mineBlock.", s, new ChatComponentTranslation("stat.mineBlock", new Object[] {
							new ItemStack(block).getChatComponent()}), item).registerStat();
    ...
    private static void initItemDepleteStats()
    {
        for (Item item : Item.itemRegistry)
        {
            if (item != null)
            {
                ...
                {
                    objectBreakStats[i] = new StatCrafting("stat.breakItem.", s, new ChatComponentTranslation("stat.breakItem", new Object[] {
							new ItemStack(item).getChatComponent()}), item).registerStat();
                }
            }
        }
