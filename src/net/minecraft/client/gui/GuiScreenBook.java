...
public class GuiScreenBook extends GuiScreen {
	...
	public void initGui() {
		...
		if (this.bookIsUnsigned) {
			this.buttonList.add(this.buttonSign = new GuiButton(3, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, Lang.format("book.signButton")));
			this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, Lang.format("gui.done")));
			this.buttonList.add(this.buttonFinalize = new GuiButton(5, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, Lang.format("book.finalizeButton")));
			this.buttonList.add(this.buttonCancel = new GuiButton(4, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, Lang.format("gui.cancel")));
		} else {
			this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 - 100, 4 + this.bookImageHeight, 200, 20, Lang.format("gui.done")));
		}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.bookGettingSigned) {
			...
			String s1 = Lang.format("book.editTitle");
			...
			String s2 = Lang.format("book.byAuthor", this.editingPlayer.getName());
			...
			String s3 = Lang.format("book.finalizeWarning");
			this.fontRendererObj.drawSplitString(s3, i + 36, j + 80, 116, 0);
		} else {
			String s4 = Lang.format("book.pageIndicator", this.currPage + 1, this.bookTotalPages);
			String s5 = "";
			...
			if (this.field_175386_A == null) {
				...
				int k1 = Math.min(128 / this.fontRendererObj.getFontHeight(), this.field_175386_A.size());

				for (int l1 = 0; l1 < k1; ++l1) {
					IChatComponent ichatcomponent2 = this.field_175386_A.get(l1);
					this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), i + 36, j + 16 + 16 + l1 * this.fontRendererObj.getFontHeight(), 0);
				}
