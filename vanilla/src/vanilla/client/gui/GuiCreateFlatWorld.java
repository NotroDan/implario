...
public class GuiCreateFlatWorld extends GuiScreen {
	...
	private final OpenableGui createWorldGui;
	...
	public GuiCreateFlatWorld(OpenableGui parent, String p_i1029_2_) {
	...
	public void initGui() {
		...
		this.flatWorldTitle = Lang.format("createWorld.customize.flat.title");
		this.field_146394_i = Lang.format("createWorld.customize.flat.tile");
		this.field_146391_r = Lang.format("createWorld.customize.flat.height");
		this.createFlatWorldListSlotGui = new GuiCreateFlatWorld.Details();
		this.buttonList.add(this.field_146389_t = new GuiButton(2, this.width / 2 - 154, this.height - 52, 100, 20, Lang.format("createWorld.customize.flat.addLayer") + " (NYI)"));
		this.buttonList.add(this.field_146388_u = new GuiButton(3, this.width / 2 - 50, this.height - 52, 100, 20, Lang.format("createWorld.customize.flat.editLayer") + " (NYI)"));
		this.buttonList.add(this.field_146386_v = new GuiButton(4, this.width / 2 - 155, this.height - 52, 150, 20, Lang.format("createWorld.customize.flat.removeLayer")));
		this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, Lang.format("gui.done")));
		this.buttonList.add(new GuiButton(5, this.width / 2 + 5, this.height - 52, 150, 20, Lang.format("createWorld.customize.presets")));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 1) {
			this.createWorldGui.open();
		} else if (button.id == 0) {
			if (createWorldGui instanceof GuiCreateWorld)
				((GuiCreateWorld) this.createWorldGui).chunkProviderSettingsJson = this.func_146384_e();
			this.createWorldGui.open();
		} else if (button.id == 5) {
	...
	class Details extends GuiSlot {
		...
		private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
			...
			worldrenderer.pos((double) p_148224_1_, (double) (p_148224_2_ + 18), (double) GuiCreateFlatWorld.this.zLevel).tex((double) ((float) (p_148224_3_ + 0) * 0.0078125F),
					(double) ((float) (p_148224_4_ + 18) * 0.0078125F)).endVertex();
			worldrenderer.pos((double) (p_148224_1_ + 18), (double) (p_148224_2_ + 18), (double) GuiCreateFlatWorld.this.zLevel).tex((double) ((float) (p_148224_3_ + 18) * 0.0078125F),
					(double) ((float) (p_148224_4_ + 18) * 0.0078125F)).endVertex();
			worldrenderer.pos((double) (p_148224_1_ + 18), (double) p_148224_2_, (double) GuiCreateFlatWorld.this.zLevel).tex((double) ((float) (p_148224_3_ + 18) * 0.0078125F),
					(double) ((float) (p_148224_4_ + 0) * 0.0078125F)).endVertex();
			worldrenderer.pos((double) p_148224_1_, (double) p_148224_2_, (double) GuiCreateFlatWorld.this.zLevel).tex((double) ((float) (p_148224_3_ + 0) * 0.0078125F),
					(double) ((float) (p_148224_4_ + 0) * 0.0078125F)).endVertex();
			tessellator.draw();
		}
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
			...
			if (entryID == 0) {
				s1 = Lang.format("createWorld.customize.flat.layer.top", flatlayerinfo.getLayerCount());
			} else if (entryID == GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - 1) {
				s1 = Lang.format("createWorld.customize.flat.layer.bottom", flatlayerinfo.getLayerCount());
			} else {
				s1 = Lang.format("createWorld.customize.flat.layer", flatlayerinfo.getLayerCount());
			}
