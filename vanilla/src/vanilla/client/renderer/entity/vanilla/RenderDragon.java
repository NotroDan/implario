...
import vanilla.client.renderer.entity.layers.LayerEnderDragonDeath;
import vanilla.client.renderer.entity.layers.LayerEnderDragonEyes;
...
public class RenderDragon extends RenderVanilla<EntityDragon>
{
    ...
    protected void rotateCorpse(EntityDragon bat, float p_77043_2_, float p_77043_3_, float partialTicks)
    {
        ...
        G.rotate(f1 * 10.0F, 1.0F, 0.0F, 0.0F);
        ...
        if (bat.deathTime > 0)
        {
            ...
            G.rotate(f2 * this.getDeathMaxRotation(bat), 0.0F, 0.0F, 1.0F);
        }
    }
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_)
    {
        ...
        G.pushMatrix();
        G.translate((float)p_180574_2_, (float)p_180574_4_ + 2.0F, (float)p_180574_6_);
        G.rotate((float) -Math.atan2((double)f4, (double)f2) * 180.0F / (float)Math.PI - 90.0F, 0.0F, 1.0F, 0.0F);
        G.rotate((float) -Math.atan2((double)f5, (double)f3) * 180.0F / (float)Math.PI - 90.0F, 1.0F, 0.0F, 0.0F);
