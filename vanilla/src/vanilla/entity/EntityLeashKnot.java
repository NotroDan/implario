	...
	public boolean interactFirst(EntityPlayer playerIn) {
		...
		if (itemstack != null && itemstack.getItem() == VanillaItems.lead && !this.worldObj.isClientSide) {
			...
			for (VanillaEntity entityliving : this.worldObj.getEntitiesWithinAABB(
					VanillaEntity.class, new AxisAlignedBB(this.posX - d0, this.posY - d0, this.posZ - d0, this.posX + d0, this.posY + d0, this.posZ + d0))) {
		...
		if (!this.worldObj.isClientSide && !flag) {
			...
			if (playerIn.capabilities.isCreativeMode) {
				...
				for (VanillaEntity entityliving1 : this.worldObj.getEntitiesWithinAABB(
						VanillaEntity.class, new AxisAlignedBB(this.posX - d1, this.posY - d1, this.posZ - d1, this.posX + d1, this.posY + d1, this.posZ + d1))) {
