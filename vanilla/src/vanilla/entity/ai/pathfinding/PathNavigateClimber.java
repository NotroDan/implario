...
public class PathNavigateClimber extends PathNavigateGround {
	...
	public PathNavigateClimber(VanillaEntity entityLivingIn, World worldIn) {
	...
	public void onUpdateNavigation() {
		if (!this.noPath()) {
			...
			if (this.targetPosition != null) {
				...
				if (this.theEntity.getDistanceSqToCenter(this.targetPosition) >= d0 && (this.theEntity.posY <= (double) this.targetPosition.getY() || this.theEntity.getDistanceSqToCenter(
						new BlockPos(this.targetPosition.getX(), MathHelper.floor_double(this.theEntity.posY), this.targetPosition.getZ())) >= d0)) {
