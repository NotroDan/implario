...
public class EntityAIControlledByPlayer extends EntityAIBase {
	...
	private final VanillaEntity thisEntity;
	...
	public EntityAIControlledByPlayer(VanillaEntity entitylivingIn, float maxspeed) {
	...
	public void updateTask() {
		...
		if (this.thisEntity.onGround) {
			f2 = this.thisEntity.worldObj.getBlockState(
					new BlockPos(MathHelper.floor_float((float) i), MathHelper.floor_float((float) j) - 1, MathHelper.floor_float((float) k))).getBlock().slipperiness * 0.91F;
		}
		...
		if (i != l || k != i1) {
			...
			if (flag && 0 == WalkNodeProcessor.func_176170_a(this.thisEntity.worldObj, this.thisEntity, l, j, i1, j1, k1, l1, false, false, true) && 1 == WalkNodeProcessor.func_176170_a(
					this.thisEntity.worldObj, this.thisEntity, i, j + 1, k, j1, k1, l1, false, false, true) && 1 == WalkNodeProcessor.func_176170_a(this.thisEntity.worldObj, this.thisEntity, l, j + 1,
					i1, j1, k1, l1, false, false, true)) {
