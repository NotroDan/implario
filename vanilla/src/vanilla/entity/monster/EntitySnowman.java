...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob {
	...
	public EntitySnowman(World worldIn) {
		...
		this.tasks.addTask(3, new EntityAIWatchClosest(this, Player.class, 6.0F));
		this.tasks.addTask(4, new EntityAILookIdle(this));
		this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, VanillaEntity.class, 10, true, false, IMob.mobSelector));
	}
	...
	public void onLivingUpdate() {
		...
		if (!this.worldObj.isClientSide) {
			...
			for (int l = 0; l < 4; ++l) {
				...
				if (this.worldObj.getBlockState(blockpos).getBlock().getMaterial() == Material.air && this.worldObj.getBiomeGenForCoords(new BlockPos(i, 0, k)).getFloatTemperature(
						blockpos) < 0.8F && Blocks.snow_layer.canPlaceBlockAt(this.worldObj, blockpos)) {
