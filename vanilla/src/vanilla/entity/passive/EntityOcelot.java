...
import vanilla.entity.ai.tasks.ocelot.EntityAIOcelotAttack;
import vanilla.entity.ai.tasks.ocelot.EntityAIOcelotSit;
...
public class EntityOcelot extends EntityTameable {
	...
	public boolean isNotColliding() {
		if (this.worldObj.checkNoEntityCollision(this.getEntityBoundingBox(), this) && this.worldObj.getCollidingBoundingBoxes(this,
