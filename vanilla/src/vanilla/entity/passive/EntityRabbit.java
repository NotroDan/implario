...
import vanilla.entity.ai.tasks.EntityAIAvoidEntity;
...
import vanilla.entity.ai.EntityJumpHelper;
...
public class EntityRabbit extends EntityAnimal {
	...
	protected void createEatingParticles() {
		this.worldObj.spawnParticle(ParticleType.BLOCK_DUST, this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width,
				this.posY + 0.5D + (double) (this.rand.nextFloat() * this.height), this.posZ + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, 0.0D, 0.0D, 0.0D,
				new int[] {Block.getStateId(Blocks.carrots.getStateFromMeta(7))});
	...
	static class AIRaidFarm extends EntityAIMoveToBlock {
		...
		public void updateTask() {
			super.updateTask();
			this.field_179500_c.getLookHelper().setLookPosition((double) this.destinationBlock.getX() + 0.5D, (double) (this.destinationBlock.getY() + 1), (double) this.destinationBlock.getZ() + 0.5D,
					10.0F, (float) this.field_179500_c.getVerticalFaceSpeed());
