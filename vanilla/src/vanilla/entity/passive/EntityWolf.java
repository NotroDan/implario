...
public class EntityWolf extends EntityTameable {
	...
	protected String getLivingSound() {
		return this.isAngry() ? "mob.wolf.growl" : this.rand.nextInt(3) == 0 ? this.isTamed() && this.dataWatcher.getWatchableObjectFloat(
				18) < 10.0F ? "mob.wolf.whine" : "mob.wolf.panting" : "mob.wolf.bark";
	}
	...
	public boolean shouldAttackEntity(EntityLivingBase e1, EntityLivingBase e2) {
		if (!(e1 instanceof EntityCreeper) && !(e1 instanceof EntityGhast)) {
			if (e1 instanceof EntityWolf) {
				EntityWolf entitywolf = (EntityWolf) e1;
