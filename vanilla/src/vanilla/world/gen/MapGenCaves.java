...
public class MapGenCaves extends MapGenBase {
	...
	protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, AnvilChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_,
		...
		for (boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
			...
			if (!flag2 && p_180702_15_ == j && p_180702_12_ > 1.0F && p_180702_16_ > 0) {
				this.func_180702_a(random.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, random.nextFloat() * 0.5F + 0.5F,
											...
											if (this.func_175793_a(iblockstate1, iblockstate2)) {
												if (j2 - 1 < 10) {
													...
													if (iblockstate2.getBlock() == Blocks.sand) {
														p_180702_5_.setBlockState(j3, j2 + 1, i2, iblockstate2.getValue(
																BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND ? Blocks.red_sandstone.getDefaultState() : Blocks.sandstone.getDefaultState());
													}
	...
	protected boolean func_175793_a(IBlockState b, IBlockState p_175793_2_) {
		return b.getBlock() == Blocks.stone ||
				b.getBlock() == Blocks.dirt ||
				b.getBlock() == Blocks.grass ||
				b.getBlock() == Blocks.hardened_clay ||
				b.getBlock() == Blocks.stained_hardened_clay ||
				b.getBlock() == Blocks.sandstone ||
				b.getBlock() == Blocks.red_sandstone ||
				b.getBlock() == Blocks.mycelium ||
				b.getBlock() == Blocks.snow_layer ||
				(b.getBlock() == Blocks.sand || b.getBlock() == Blocks.gravel) && p_175793_2_.getBlock().getMaterial() != Material.water;
	}
