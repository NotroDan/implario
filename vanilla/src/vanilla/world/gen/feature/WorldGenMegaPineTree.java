...
public class WorldGenMegaPineTree extends WorldGenHugeTrees
{
    ...
    private static final IBlockState field_181634_f = Blocks.leaves.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.SPRUCE).withProperty(BlockLeaves.CHECK_DECAY,
			Boolean.FALSE);
    ...
    {
        this.func_175933_b(world, pos.west().north());
        this.func_175933_b(world, pos.east(2).north());
        this.func_175933_b(world, pos.west().south(2));
        this.func_175933_b(world, pos.east(2).south(2));
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            if (k == 0 || k == 7 || l == 0 || l == 7)
            {
                this.func_175933_b(world, pos.add(-3 + k, 0, -3 + l));
            }
        }
    }
