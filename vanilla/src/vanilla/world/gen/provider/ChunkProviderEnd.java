...
public class ChunkProviderEnd implements VanillaChunkProvider {
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
		...
		BiomeGenBase biomeGenBase = BiomeGenBase.toGenBase(endWorld.getBiomeGenForCoords(blockpos.add(16, 0, 16)));
		biomeGenBase.decorate(this.endWorld, this.endWorld.rand, blockpos);
	...
	public List<SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
		return BiomeGenBase.end.getSpawnableList(creatureType);
	}
