...
import vanilla.world.gen.structure.MapGenNetherBridge;
...
public class ChunkProviderHell implements VanillaChunkProvider {
	...
	public void func_180516_b(int p_180516_1_, int p_180516_2_, ChunkPrimer p_180516_3_) {
		...
		this.netherrackExclusivityNoise = this.netherrackExculsivityNoiseGen.generateNoiseOctaves(this.netherrackExclusivityNoise, p_180516_1_ * 16, p_180516_2_ * 16, 0, 16, 16, 1, d0 * 2.0D,
				d0 * 2.0D, d0 * 2.0D);
	...
	public Chunk provideChunk(int x, int z) {
		...
		Biome[] abiomegenbase = this.worldObj.getWorldChunkManager().loadBlockGeneratorData(null, x * 16, z * 16, 16, 16);
		byte[] abyte = chunk.getBiomeArray();

		for (int i = 0; i < abyte.length; ++i) {
			abyte[i] = (byte) abiomegenbase[i].getLegacyId();
		}
