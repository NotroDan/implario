...
public class StructureOceanMonument extends MapGenStructure {
	...
	private static final List<SpawnListEntry> field_175803_h = Lists.newArrayList();
	...
	protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
		...
		if (i == k && j == l) {
			if (this.worldObj.getWorldChunkManager().getBiome(new BlockPos(i * 16 + 8, 64, j * 16 + 8), (BiomeGenBase) null) != BiomeGenBase.deepOcean) {
				return false;
			}
